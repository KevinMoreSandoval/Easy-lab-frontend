  ...
  return (
    <div className={styles.layout}>
      <aside className={styles.sidebar}>
        ...
        {/* Pacientes (ahora te lleva a su propia pantalla) */}
        <div className={styles.navItem} onClick={() => navigate('/recepcion/registro-pacientes')}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" style={{ width: '20px', height: '20px' }}>
        ...
        <div className={styles.navItem} onClick={() => navigate('/recepcion/citas-medicas')}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" style={{ width: '20px', height: '20px' }}>
        ...
        <div className={styles.navItem} onClick={() => navigate('/recepcion/confirmacion-llegada')}>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" style={{ width: '20px', height: '20px' }}>
